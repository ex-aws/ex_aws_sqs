defmodule ExAws.SQSTest do
  ...
  test "#list_queues with options" do
    expected = %{"Action" => "ListQueues", "QueueNamePrefix" => "prefix"}
  ...
  test "#set_queue_attributes" do
    ...
    assert expected ==
             SQS.set_queue_attributes("982071696186/test_queue", visibility_timeout: 10).params
  end
  ...
  test "#remove_permission" do
    ...
    assert expected ==
             SQS.remove_permission("982071696186/test_queue", "TestAddPermission").params
  end
  ...
  test "#send_message_batch" do
    expected = %{
      ...
      "SendMessageBatchRequestEntry.1.MessageAttribute.2.Value.BinaryValue" =>
        :zlib.gzip("testing!"),
  ...
  test "#delete_message_batch" do
    expected = %{
      ...
      "DeleteMessageBatchRequestEntry.2.ReceiptHandle" =>
