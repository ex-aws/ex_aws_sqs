  ...
  for parser <- [ExAws.SQS.SweetXmlParser, ExAws.SQS.SaxyParser] do
    describe "#{inspect(parser)}" do
      ...
      test "parsing a create queue response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :create_queue)
      ...
      test "parsing a change message visibility response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :change_message_visibility)
      ...
      test "parsing a change message visibilty batch response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :change_message_visibility_batch)
      ...
      test "parsing a delete message response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :delete_message)
      ...
      test "parsing a delete message batch response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :delete_message_batch)
      ...
      test "parsing a delete queue response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :delete_queue)
      ...
      test "parsing a get queue attributes response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :get_queue_attributes)
      ...
      test "parsing a get queue url response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :get_queue_url)
      ...
      test "parse list dead letter source queues response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :list_dead_letter_source_queues)
      ...
      test "parsing a purge queue response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :purge_queue)
        assert "6fde8d1e-52cd-4581-8cd9-c512f4c64223" == response[:request_id]
      end
      ...
      test "parsing a receive message response" do
        ...
        assert 195_004_372_649 == attributes["sender_id"]
        assert 1_238_099_229_000 == attributes["sent_timestamp"]
        assert 5 == attributes["approximate_receive_count"]
        assert 1_250_700_979_248 == attributes["approximate_first_receive_timestamp"]
      end
      ...
      test "it should handle parsing a message with custom attributes" do
        ...
        assert %{value: <<2, 4, 6, 8, 10, 12>>, data_type: "Binary.gif"} =
                 message_attributes["GifVal"]

        assert %{value: "http://elixir-lang.org", data_type: "String.URL"} =
                 message_attributes["UrlVal"]
      ...
      test "handling a remove permission response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :remove_permission)
      ...
      test "handling a send message response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :send_message)
      ...
      test "handling a send message batch response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :send_message_batch)
      ...
      test "it should handle a set queue attributes response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :set_queue_attributes)
      ...
      test "handling list tags response" do
        ...
        {:ok, %{body: response}} = @parser.parse(rsp, :list_queue_tags)
